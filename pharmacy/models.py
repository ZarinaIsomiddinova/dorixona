...
class Stock(models.Model):
    category = models.ForeignKey(Category, null=True, on_delete=models.CASCADE, blank=True, verbose_name='turkum')
    drug_imprint = models.CharField(max_length=6, blank=True, null=True)
    drug_name = models.CharField(max_length=50, blank=True, null=True, verbose_name='dori_nomi')
    drug_color = models.CharField(max_length=50, blank=True, null=True, verbose_name='dori_rangi')
    drug_shape = models.CharField(max_length=50, blank=True, null=True, verbose_name="dori Ko'rinishi")
    quantity = models.IntegerField(default='0', blank=True, null=True, verbose_name='soni')
    receive_quantity = models.IntegerField(default='0', blank=True, null=True)
    reorder_level = models.IntegerField(default='0', blank=True, null=True)
    manufacture = models.CharField(max_length=50, blank=True, null=True, verbose_name="ishlab chiqaruvchi")
    last_updated = models.DateTimeField(auto_now_add=False, auto_now=True, verbose_name='yangilangan_sana')
    timestamp = models.DateTimeField(auto_now_add=True, auto_now=False)
    drug_strength = models.CharField(max_length=10, blank=True, null=True, verbose_name="dori tasiri")
    ...
    drug_description = models.TextField(blank=True, max_length=1000, null=True, verbose_name='dori_haqida')
    drug_pic = models.ImageField(default="images2.png", null=True, blank=True, verbose_name='dori_rasmi')
...
class Dispense(models.Model):
    patient_id = models.ForeignKey(Patients, on_delete=models.DO_NOTHING, null=True, verbose_name='bemor_id')
    drug_id = models.ForeignKey(Stock, on_delete=models.SET_NULL, null=True, blank=False, verbose_name='dori_id')
    dispense_quantity = models.PositiveIntegerField(default='1', blank=False, null=True, verbose_name='soni')
...
class PatientFeedback(models.Model):
    ...
    patient_id = models.ForeignKey(Patients, on_delete=models.CASCADE, verbose_name='bemor_id')
    admin_id = models.ForeignKey(AdminHOD, null=True, on_delete=models.CASCADE)
    pharmacist_id = models.ForeignKey(Pharmacist, null=True, on_delete=models.CASCADE, verbose_name='farmaseftika_id')
    feedback = models.TextField(null=True, verbose_name='xabar')
